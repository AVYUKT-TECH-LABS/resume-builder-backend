...
export default class EmployerBatchController {
    ...
    async uploadJD(
        ...
        await this.employerService.uploadBatchJD(body.batchId, req.employer.id, file);
    ...
    async createJD(
        ...
        await this.employerService.createBatchJD(body.batchId, req.employer.id, body.jd);
