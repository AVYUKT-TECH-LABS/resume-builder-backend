...
export class CreateJobDto {
  ...
  @IsString()
  @MinLength(3, { message: 'Please enter a valid company name' })
  company_name: string;
  ...
  @IsEnum(['10_or_below_10', '12_pass', 'diploma', 'graduate'])
  minimum_edu: '10_or_below_10' | '12_pass' | 'diploma' | 'graduate';
