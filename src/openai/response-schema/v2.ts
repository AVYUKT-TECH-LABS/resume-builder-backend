...
const personalInformation = z.object({
    ...
    address: z.string().describe('The address of the person on resume'),
    linkedin: z.string().describe('The linkedin profile of the person on resume'),
    sex: z.string().describe('The sex of the person on resume'),
    dob: z.string().describe('The date of birth of the person on resume'),
    passport_number: z
        .string()
        .describe('The passport number of the person on resume'),
});
